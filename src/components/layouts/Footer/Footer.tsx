...
const Footer = () => {
  return (
    <footer className="flex flex-col gap-12 bg-gray-100 py-16">
      <section className="page-width flex items-center justify-center">
        <h3>Neem contact op</h3>
      </section>
      <section className="page-width flex flex-col gap-4">
        <div className="default-rounding flex w-full items-center justify-center border border-gray-200 bg-white py-6">
          <p>+31 6 80056004</p>
        </div>
        <div className="default-rounding flex w-full items-center justify-center border border-gray-200 bg-white py-6">
